...
**To contribute to LibreStand, please:**

1. Fork the repository on GitHub
2. Clone the repository locally on your machine
  ```sh
  git clone https://github.com/you/LibreStand.git
  ```
...
Your pull requests will be declined if they violate our [code of conduct](https://github.com/BLM16/LibreStand/blob/master/.github/CODE_OF_CONDUCT.md). You may be requested to make changes (or have others make changes) before we integrate them into our library. All tests and CodeQL Analysis **must succeed** before we integrate the pull request.
...
**Thank you for contributing to LibreStand!**
